...
declare const buttonTheme: {
    ...
    defaultProps?: {
        size?: string | number | undefined;
        variant?: "link" | "outline" | "solid" | "ghost" | "subtle" | "elevated" | "primary" | "secondary" | "tertiary" | undefined;
        colorScheme?: string | undefined;
    } | undefined;
};
...
declare const nativeSelectTheme: {
    baseStyle?: Partial<Record<"element" | "group" | "addon" | "field", _chakra_ui_styled_system.SystemStyleObject>> | _chakra_ui_styled_system.PartsStyleFunction<{
        keys: ("element" | "group" | "addon" | "field")[];
    }> | undefined;
    sizes?: {
        sm: {
...
declare const selectTheme: {
    ...
    defaultProps?: {
        size?: "sm" | "md" | "lg" | undefined;
        variant?: "outline" | "filled" | "flushed" | "unstyled" | undefined;
        colorScheme?: string | undefined;
    } | undefined;
};
...
declare const menuTheme: {
    ...
    sizes?: {
        [key: string]: _chakra_ui_styled_system.PartsStyleInterpolation<{
            keys: ("icon" | "button" | "item" | "list" | "groupTitle" | "command" | "divider")[];
        }>;
    } | undefined;
    variants?: {
        dialog: () => {
    ...
    parts: ("icon" | "button" | "item" | "list" | "groupTitle" | "command" | "divider")[];
};
...
declare const modalTheme: {
    ...
    sizes?: {
        [key: string]: _chakra_ui_styled_system.PartsStyleInterpolation<{
            keys: ("overlay" | "body" | "header" | "footer" | "dialog" | "dialogContainer" | "closeButton")[];
        }>;
    } | undefined;
    variants?: {
        [key: string]: _chakra_ui_styled_system.PartsStyleInterpolation<{
    ...
    parts: ("overlay" | "body" | "header" | "footer" | "dialog" | "dialogContainer" | "closeButton")[];
};
...
declare const emptyStateTheme: {
    ...
    sizes?: {
        [key: string]: _chakra_ui_styled_system.PartsStyleInterpolation<{
            keys: ("container" | "icon" | "title" | "body" | "footer" | "descripton" | "actions")[];
        }>;
    } | undefined;
    variants?: {
        [key: string]: _chakra_ui_styled_system.PartsStyleInterpolation<{
    ...
    parts: ("container" | "icon" | "title" | "body" | "footer" | "descripton" | "actions")[];
};
...
declare const stepperTheme: {
    ...
    parts: ("number" | "container" | "icon" | "title" | "description" | "content" | "separator" | "item" | "stepper" | "step" | "indicator")[];
};
